...
/**
 * brand-guide theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { brandGuideTheme } from './brand-guide';
 *   import './brand-guide.css';
 */
export const brandGuideTheme = {
  name: 'brand-guide',
  __built: true,
  tokens: {
    ...
    "--font-family-body": "var(--font-geist-sans), \"Geist\", \"IBM Plex Sans\", system-ui, sans-serif",
    "--font-family-heading": "var(--font-geist-sans), \"Geist\", \"IBM Plex Sans\", system-ui, sans-serif",
    ...
    "--color-background-body": "light-dark(#dcdcdc, #dcdcdc)",
    "--color-background-card": "light-dark(#f5f5f5, #f5f5f5)",
    "--color-background-popover": "light-dark(#F7FEFA, #2D312F)",
    "--color-background-muted": "light-dark(#e8e8e8, #e8e8e8)",
    "--color-accent": "light-dark(#111111, #111111)",
    ...
    "--color-neutral": "light-dark(#181D1A1A, #DEE4E033)",
    "--color-overlay": "light-dark(#181D1A66, #181D1A99)",
    "--color-overlay-hover": "light-dark(#181D1A0D, #FFFFFF0D)",
    "--color-overlay-pressed": "light-dark(#181D1A1A, #FFFFFF1A)",
    "--color-text-primary": "light-dark(#111111, #111111)",
    "--color-text-secondary": "light-dark(#4a4a4a, #4a4a4a)",
    "--color-text-disabled": "light-dark(#6b6b6b, #6b6b6b)",
    ...
    "--color-icon-primary": "light-dark(#111111, #111111)",
    "--color-icon-secondary": "light-dark(#4a4a4a, #4a4a4a)",
    "--color-icon-disabled": "light-dark(#6b6b6b, #6b6b6b)",
    ...
    "--color-border": "light-dark(#d0d0d0, #d0d0d0)",
    "--color-border-emphasized": "light-dark(#A2AEA7, #3F4943)",
    "--color-skeleton": "light-dark(#A2AEA7, #3F4943)",
    ...
    "--color-background-inverted": "light-dark(#111111, #111111)",
    "--color-track": "light-dark(#A2AEA7, #3F4943)",
    "--radius-chat": "56px",
    "--font-family-mono": "ui-monospace, \"SF Mono\", Monaco, Consolas, \"Liberation Mono\", \"Courier New\", monospace"
  },
